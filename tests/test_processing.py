...
def test_filter_by_state(state):
    """Тест для функции которая принимает на вход список словарей и значение для ключа,и возвращает новый
         список содержащий только те словари у которых ключ содержит переданное в функцию значение"""
...
def test_sort_by_date(state):
    """Тест для функции сортирующей исходные данные по дате,по возрастанию"""
...
def test_sort_by_date_reverse(state):
    """Тест для функции сортирующей исходные данные по дате,по убыванию"""
